...
const Signup = () => {
  ...
  const handleSignup = async () => {
    try {
      ...
      try {
        const testResponse = await axios.get('http://192.168.8.103:8081/api/test/db-connection', {
          timeout: 5000
        });
      ...
      const response = await axios.post('http://192.168.8.103:8081/api/auth/signup', userData, {
        headers: {
